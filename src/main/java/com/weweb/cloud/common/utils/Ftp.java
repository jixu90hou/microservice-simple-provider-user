...
public class Ftp {
    ...
    public static void main(String[] args) throws IOException {
        Ftp ftp=new Ftp("192.168.1.111",9921,"admin","admin123");
        ftp.ftpLogin();
        //上传文件夹
        String filePath="/Users/jackshen/Desktop/test/";
         filePath="/Users/jackshen/Desktop/timg.jpeg";

        String remotePath="/Users/jackshen/Downloads/devtools/demo/";
        remotePath="test";
        boolean flag=ftp.uploadDirectory(filePath, remotePath);
        System.out.println("upload file:"+flag);
        //下载文件夹
