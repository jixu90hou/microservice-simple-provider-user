 ...
 *
 * @author范芳铭 通过commons net中的FTP包进行FTP的简单操作.FTP登陆，上传文件，上传文件夹，下载，退出登陆
 * @author范芳铭
 */
...
public class EasyFTPClientUsage {
    ...
    public EasyFTPClientUsage(String strIp, int intPort, String user,
...
// FtpClient的Set 和 Get 函数
    ...
    public static void main(String[] args) throws IOException {
        ...
        EasyFTPClientUsage ftp = new EasyFTPClientUsage("192.168.1.111", 9921,
       ...
       boolean flag1=ftp.uploadFile(new File(filePath), "test");
        System.out.println("upload file:"+flag1);
        // 上传文件夹

      //  ftp.uploadDirectory("D:/ffm83/", "/ftpFile/");

        // 下载文件夹
        //String downloadPath=remotePath+"download";
       // boolean flag=ftp.downLoadDirectory("/Users/jackshen/Desktop/download/", "gradle-3.1-bin.zip");
